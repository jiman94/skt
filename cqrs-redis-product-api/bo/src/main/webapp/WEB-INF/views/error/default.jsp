...
<%
	String mobile = (String) request.getAttribute("isMobile");
	//Log logger = new Log(getClass());
	...
	if (request.getHeader("referer") != null && request.getHeader("referer").indexOf("uploadify") >= 0) {
		...
		//logger.error( "{} \nParams=[{}]", errmsg, Util.getParams( req.getParameterNames(), req.getParameterMap() ) );
	}
%>
...
<link rel="shortcut icon" href="/resources/html/images/common/favicon.ico" type="image/x-icon">
<link rel="icon" href="/resources/html/images/common/favicon.ico" type="image/x-icon">
...
<% }else{ %>
<table border="0" style="height:300px; width:100px"><tr><td>
	<div class="errorWrap">
		<div class="contents">
			<h1>이용에 불편을 드려 죄송합니다.</h1>
			<p>
