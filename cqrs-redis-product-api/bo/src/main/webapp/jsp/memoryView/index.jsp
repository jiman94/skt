...
%>
        <tr>
            <td style="text-align: left"><%= threadInfo.getThreadName() %></td>
            <td><%= threadInfo.getBlockedCount() %></td>
            <td><%= threadInfo.getBlockedTime() %></td>
            <td><%= threadInfo.getWaitedCount() %></td>
            <td><%= threadInfo.getWaitedTime() %></td>
        </tr>
<% } %>
    </table>
</body>
