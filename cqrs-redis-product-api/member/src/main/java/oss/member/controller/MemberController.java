...
import oss.member.error.ErrorResource;
import oss.member.error.FieldErrorResource;
import oss.member.exception.InvalidRequestException;
...
public class MemberController {
	...
	public ResponseEntity<oss.member.model.read.Member> getMember(@PathVariable final String id) {
		final oss.member.model.read.Member member = memberReadRepository.findAllById(id);
		return new ResponseEntity<>(member, HttpStatus.CREATED);
	}
